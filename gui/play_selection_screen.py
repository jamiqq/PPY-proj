...
class PlaySelectionScreen(ttk.Frame):  # inherit from ttk.Frame
    def __init__(self, parent, controller):
        ...
        btn_classic = ttk.Button(self, text="Classic", width=20, command=self.play_classic, style="TButton")
        btn_classic.pack(pady=10)

        btn_custom = ttk.Button(self, text="Custom Word", width=20, command=self.play_custom, style="TButton")
        btn_custom.pack(pady=10)

        btn_category = ttk.Button(self, text="Category", width=20, command=self.play_category, style="TButton")
        btn_category.pack(pady=10)

        btn_back = ttk.Button(self, text="Back to Menu", command=lambda: controller.show_frame("MainMenu"), style="TButton")
    ...
    def play_custom(self):
        ...
        btn_play = ttk.Button(popup, text="Play", command=start_game, style="TButton")
        btn_play.pack(side="left", padx=20, pady=20)

        btn_back = ttk.Button(popup, text="Back", command=cancel, style="TButton")
